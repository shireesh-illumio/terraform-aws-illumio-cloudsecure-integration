...
resource "illumio-cloudsecure_aws_organization_account" "example" {
  account_id         = data.aws_caller_identity.current.account_id
  role_arn           = aws_iam_role.illumio_cloud_integration_role.arn
  role_external_id   = random_uuid.role_secret.result
  organization_master_account_id  = data.aws_organizations_organization.current.master_account_id
}